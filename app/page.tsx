    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center gap-4">
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  ...
                  <Button variant="outline" onClick={logout} className="text-sm bg-transparent">
                    Logout
                  </Button>
                </div>
              ) : (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto text-pretty">{t.homeSubtitle}</p>
          ...
          {!user ? (
            ...
            <div className="bg-white rounded-lg shadow-sm border p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">You're successfully logged in to WordWise.</p>
        ...
        {!user && (
          <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-md mx-auto">
            <h3 className="text-lg font-semibold text-blue-900 mb-2">Demo Account</h3>
            <p className="text-blue-700 text-sm mb-3">Try the demo with these credentials:</p>
